...
//AUIGantt Export 시 로컬에 다운로드 가능하도록 작성된 서버사이드 예제입니다.
//AUIGantt 가 xlsx 형식을 작성하여 base64 로 인코딩하여 data 파라메터로 post 요청을 합니다.
...
// AUIGantt.exportAsXlsx() 사용시 exportProps 로 파일명을 지정해 줬다면 다음과 같이 지정된 파일명을 얻을 수 있습니다.
...
String filename = "BITBOX." + extension; // 다운로드 될 파일명
